            ...
            <ul data-role="listview" data-split-icon="delete" data-split-theme="d">
                ...
                if (isset($cat[0])) {
                    ...
                    foreach ($cat as $key => $value)
                    {
                        ...
                        </span><span class="ui-li-count"><a href="removeCat.php?c=<?php echo $value["id"];?>">x</a></span></li>
                ...
                else
                {
                    if (isset($cat["id"])) {
                        ...
                        <?php echo $catCount["total"];?>
                    </span><span class="ui-li-count"><a href="removeCat.php?c=<?php echo $cat["id"];?>">x</a></span></li>
