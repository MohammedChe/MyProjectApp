...
class DB {
	...
	protected $db_name = 'db_081a1e6e';
	protected $db_user = 'user_081a1e6e';
	protected $db_pass = 'xlC4F!dR0%$A$&';
	protected $db_host = 'a.db.shared.orchestra.io';
    ...
    public function select($table, $where, $var = '*') {
        $sql = "SELECT $var FROM $table WHERE $where ORDER BY id DESC";
