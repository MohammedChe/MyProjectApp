...
<li id="latest"><a href="#">
    ...
    <ul class="autoWidth">
        ...
        foreach ($marks2 as $key => $value)
        {
            ...
            ?>
            <li><a target="_blank" href="<?php echo htmlentities($value["url"]);?>"><img id="favi"
                                                                                         src="<?php echo 'http://www.google.com/s2/favicons?domain=' . $url; ?>"><span
                id="recentURL"><?php echo $url;?></span></a></li>
            <?php
        }
        ?>
    </ul>
    ...
    <li id="latest"><a href="#">
        ...
        <ul class="autoWidth">
            ...
            ?>
            <li><a target="_blank" href="<?php echo $marks2["url"];?>"><img id="favi"
                                                                            src="<?php echo 'http://www.google.com/s2/favicons?domain=' . $url; ?>"><span
                id="recentURL"><?php echo $url;?></span></a></li>
        </ul>
    </li>
                    ...
                    <div class="accordion">
                        ...
                        if (isset($marks3[0])) {
                            foreach ($marks3 as $key => $value) :
                                ...
                                ?>
                                <a target="_blank" href="<?php echo $value["url"]?>"><img id="favi"
                                                                                          src="<?php echo 'http://www.google.com/s2/favicons?domain=' . $urlink; ?>"> <?php echo $url2; ?>
                                </a>
                            ...
                            if (isset($marks3["url"])) {
                                ...
                                ?>
                                <a target="_blank" href="<?php echo $marks3["url"]?>"><img id="favi"
                                                                                           src="<?php echo 'http://www.google.com/s2/favicons?domain=' . $urlink; ?>"><?php echo $url2; ?>
                                </a>
...
if (isset($cat[0])) {
    ...
    <ul>
        ...
        foreach ($cat as $key => $value)
        {
            ?>
            <li><a
                onClick="getMarks(<?php echo htmlentities($value["id"])?>, '<?php echo htmlentities($value["title"])?>');"
                href="#"><?php echo htmlentities($value["title"])?></a></li>
            <?php
        }
...
else
{
    if (isset($cat["id"])) {
        ?>
    <li><a onClick="getMarks(<?php echo htmlentities($cat["id"])?>, '<?php echo htmlentities($cat["title"])?>');"
           href="#"><?php echo htmlentities($cat["title"])?></a></li>
        <?php
