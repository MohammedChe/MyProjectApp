		...
		?>
                ...
                <li id="categories" class="send_right2 "><a class="round_left2" href="#">
                    ...
                    foreach ($cat as $key => $value) 
                    {
                        ...
                        echo "<li onClick='getMarks(" . htmlentities($value["id"]) .",". htmlentities($value["title"]) .");'>" . htmlentities($value["title"]) . "</li>";
                    }
                    ...
                    ?>
					  ...
					  {						  
						 ...
						 echo "<li onClick='getMarks(" . htmlentities($cat["id"]) .",". htmlentities($cat["title"]) .");'>" . htmlentities($cat["title"]) . "</li>";
