            ...
            <ul data-role="listview" data-split-icon="delete" data-split-theme="d">
                ...
                if (isset($cat[0])) {
                    ...
                    foreach ($cat as $key => $value)
                    {
                        ...
                        </span><span class="ui-icon ui-icon-plus ui-icon-shadow" id="add"><a href="removeCat.php?c=<?php echo $value["id"];?>" data-ajax="false"></a></span></li>
                ...
                else
                {
                    if (isset($cat["id"])) {
                        ...
                        <?php echo $catCount["total"];?>
                    </span><span class="ui-icon ui-icon-plus ui-icon-shadow" id="add"><a href="removeCat.php?c=<?php echo $cat["id"];?>" data-ajax="false"></a></span></li>
